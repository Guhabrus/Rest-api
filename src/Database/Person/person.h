    ...
    class Person
    {
        ...
        public:
            ...
            */
             ...
             * 
             * @param id_cache идентификатор кеша (сейчас это логин)
             * @param man       указатель на объект в который будет положен результат
             * @return true     в случае если объект найдет
             * @return false    в случае если объекта нет в кеше
             */
